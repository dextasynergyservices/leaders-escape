...
export default function About() {
	...
	return (
		...
		>
			<div
				ref={ref}
				className={`mx-auto max-w-5xl px-6 py-24 md:px-10 md:py-36 transition-all duration-1000 ${
					isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
				}`}
			>
				<div className="flex flex-col items-center text-center">
					<p className="mb-4 text-[12px] font-semibold uppercase tracking-[0.32em] text-[#E0672A] md:text-[13px]">
						ABOUT LEADERS&apos; ESCAPE
					</p>

					<h2 className="max-w-4xl font-serif text-[2.4rem] leading-[1.08] text-[#0D4D55] md:text-[4.2rem] lg:text-[4.8rem]">
						Step Away.
						<br />
						Lead Forward.
					</h2>

					<p className="max-w-3xl text-[17px] leading-8 text-[#45646A] md:text-[20px] md:leading-10">
